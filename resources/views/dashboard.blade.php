...
(function() {
    ...
    const labels = @json(array_column($dailyStats, 'day'));
    const data = @json(array_column($dailyStats, 'total'));
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Total Orders',
                data: data,
                borderColor: 'rgb(128, 87, 67)',
                backgroundColor: 'rgba(128, 87, 67, 0.1)',
                borderWidth: 2,
                pointBackgroundColor: 'rgb(128, 87, 67)',
            ...
            scales: {
                x: {
                    title: {
                        ...
                        text: 'Date',
                        color: '#80756e',
                        font: { family: 'Hanken Grotesk', weight: '500', size: 12 }
                    },
                    grid: { display: false },
                    ticks: { color: '#998374', font: { family: 'Hanken Grotesk', size: 11 } }
                },
                y: {
                    beginAtZero: true,
