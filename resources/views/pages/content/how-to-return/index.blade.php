...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
    <div>
        <h1 class="font-headline-lg text-headline-lg text-on-surface">How To Return</h1>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-outline-variant/20">
                ...
                @empty
                <tr>
                    <td colspan="3" class="px-gutter py-8 text-center text-on-surface-variant">No guides found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
