...
@section('title', 'Edit How To Return')

@section('content')
<div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
    <div>
        <h1 class="font-headline-lg text-headline-lg text-on-surface">Edit How To Return</h1>
...
<form method="POST" action="{{ route('content.how-to-return.update', $item->id) }}" id="howToReturnForm" class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-outline-variant/30 p-6">
        ...
        <div class="space-y-1.5 mt-4">
            ...
            <input type="text" name="slug" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., cara-pengembalian-barang" required value="{{ old('slug', $item->slug) }}">
        ...
        <div class="space-y-1.5 mt-4">
            ...
            <textarea name="content" rows="6" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="Full guide content..." required>{{ old('content', $item->content) }}</textarea>
