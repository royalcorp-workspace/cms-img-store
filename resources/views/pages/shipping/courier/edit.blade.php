            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <select name="courier_type" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none bg-white select2-enable" required>
                        <option value="expedisi" {{ old('courier_type', $courier->courier_type ?? 'expedisi') == 'expedisi' ? 'selected' : '' }}>Ekspedisi</option>
                        <option value="toko" {{ old('courier_type', $courier->courier_type ?? '') == 'toko' ? 'selected' : '' }}>Kurir Toko</option>
                    </select>
