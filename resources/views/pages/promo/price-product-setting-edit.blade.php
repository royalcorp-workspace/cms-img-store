        ...
        <div class="rounded-xl shadow-sm border border-outline-variant/30 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                ...
                <div class="space-y-1.5" id="discountValueContainer">
                    ...
                    <input type="number" name="discount_value" step="any" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="0-100" required value="{{ old('discount_value', $setting->discount_value) }}" id="discountValueInput">
