...
@section('content')
    ...
    <form id="bundleForm" action="{{ route('bundlings.store') }}" method="POST" enctype="multipart/form-data" class="w-full space-y-6"
         x-data="{ 
        ...
        <div class="w-full bg-white rounded-2xl shadow-sm border border-outline-variant/30 p-6 space-y-6">
            <div class="border-b border-outline-variant/20 pb-3">
                ...
                <p class="text-xs text-on-surface-variant mt-0.5">Nama paket, slug URL, harga bundling, dan status aktif.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none text-body-md" placeholder="e.g. Paket Kamar Tidur Utama" required>
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none text-body-md" placeholder="e.g. paket-kamar-tidur-utama">
            ...
            <div class="space-y-1.5">
                ...
                <textarea name="description" rows="3" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none text-body-md" placeholder="Deskripsikan paket bundling ini...">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="space-y-4 pt-6 border-t border-outline-variant/30">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-xs text-on-surface-variant">Pilih produk dan tentukan jumlah yang termasuk di paket bundling ini.</p>
                    </div>
            ...
            <div class="flex items-center justify-end gap-3 pt-6 border-t border-outline-variant/30">
                ...
                <button type="submit" class="btn-save px-6 py-2.5 bg-primary text-white rounded-xl text-xs font-bold hover:opacity-90 transition-all shadow-sm active:scale-95">Simpan Bundle</button>
            </div>
        </div>
    </form>
@endsection
