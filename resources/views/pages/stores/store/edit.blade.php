...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <h1 class="font-headline-lg text-headline-lg text-on-surface">Edit Store</h1>
    ...
    <form method="POST" action="{{ route('stores.update', $store->id) }}" class="space-y-6">
        @csrf
        @method('PUT')
        <div class="bg-white rounded-xl shadow-sm border border-outline-variant/30 p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="code" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., TOKO_A" required value="{{ old('code', $store->code) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., Toko A" required value="{{ old('name', $store->name) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="credit_limit" value="{{ old('credit_limit', $store->credit_limit) }}" min="0" step="0.01" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none">
            ...
            <div class="space-y-1.5 mt-4">
                ...
                <textarea name="address" rows="2" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="Store address">{{ old('address', $store->address) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $store->phone) }}" maxlength="50" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="email" name="email" value="{{ old('email', $store->email) }}" maxlength="255" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="payment_term" value="{{ old('payment_term', $store->payment_term) }}" min="0" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', $store->sort_order) }}" min="0" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none">
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit" class="px-10 py-3 bg-primary text-white rounded-lg font-label-md hover:opacity-90 transition-all shadow-sm">Update Store</button>
        </div>
    </form>
@endsection
