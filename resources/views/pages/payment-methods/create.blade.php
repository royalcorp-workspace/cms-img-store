...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            <h1 class="font-headline-lg text-headline-lg text-on-surface">Create Payment Method</h1>
    ...
    <form method="POST" action="{{ route('payment-methods.store') }}" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-outline-variant/30 p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="code" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., BCA_TRANSFER" required value="{{ old('code') }}">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="name" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., BCA Virtual Account" required value="{{ old('name') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="provider" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., BCA, Xendit" value="{{ old('provider') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="image" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="https://..." value="{{ old('image') }}">
            ...
            <div class="mt-4">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="has_charge" value="1" {{ old('has_charge') ? 'checked' : '' }} class="w-4 h-4 text-primary border-outline-variant rounded focus:ring-primary" id="hasChargeCheckbox">
                    <span class="text-label-sm font-medium text-on-surface-variant">Has Additional Charge</span>
                </label>
            </div>
            <div id="chargeFields" class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 {{ old('has_charge') ? '' : 'hidden' }}">
                <div class="space-y-1.5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="charge_value" step="0.01" min="0" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="0.00" value="{{ old('charge_value') }}">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="text" name="charge_bearer" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="e.g., merchant" value="{{ old('charge_bearer') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="minimum_amount" step="0.01" min="0" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="0.00" value="{{ old('minimum_amount') }}">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="maximum_amount" step="0.01" min="0" class="w-full px-3 py-2 border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:outline-none" placeholder="0.00" value="{{ old('maximum_amount') }}">
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit" class="px-10 py-3 bg-primary text-white rounded-lg font-label-md hover:opacity-90 transition-all shadow-sm">Save Payment Method</button>
        </div>
    </form>
@endsection
