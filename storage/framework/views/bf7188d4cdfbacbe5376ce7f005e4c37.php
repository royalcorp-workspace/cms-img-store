<aside class="fixed left-0 top-0 h-full w-sidebar-width bg-sidebar-bg flex flex-col py-6 z-50 transition-all duration-300">
    ...
    <nav class="flex-1 overflow-y-auto sidebar-scroll space-y-1">
        ...
        ?>
        <?php $__currentLoopData = $menuGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <p class="px-4 py-2 text-label-sm uppercase text-sidebar-text opacity-50 tracking-widest font-bold <?php echo e($menu['order'] > 1 ? 'mt-4' : ''); ?>"><?php echo e($menu['title']); ?></p>
            <?php $__currentLoopData = $menu['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="flex items-center gap-3 px-4 py-3 text-sidebar-text hover:bg-sidebar-active/10 hover:text-sidebar-active transition-colors duration-200 rounded-lg mx-2 <?php echo e(request()->routeIs($child['route_name'] . '*') ? 'bg-primary-container text-sidebar-active translate-x-1 transition-transform duration-200' : ''); ?>" href="<?php echo e(route($child['route_name'])); ?>">
                    <span class="material-symbols-outlined"><?php echo e($child['icon']); ?></span>
                    <span class="font-label-md text-label-md"><?php echo e($child['title']); ?></span>
                </a>
...
</aside><?php /**PATH /var/www/html/resources/views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>